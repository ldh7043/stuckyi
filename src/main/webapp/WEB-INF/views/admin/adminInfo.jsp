...
<body>
       ...
       <script>
         ...
         $(function(){
           ...
           function parseJJSON(jsonObj){
               ...
               var table="<tr><th>회원아이디</th><th>회원이름</th><th>회원Email</th></tr>";
   ...
   <div id="updatetitle"><h1>게시글 목록</h1><br></div>
    ...
    <script>
      ...
      var END_INDEX = 10;
        ...
        function parseBJSON(jsonObj){
            ...
            var table="<tr><th>카테고리</th><th>제목</th><th>등록일</th><th>글 삭제</th></tr>";
            for (i = 0; i < row.length; i++) { 
                if(row[i].userId.trim() == "<%=(String)request.getAttribute("id") %>") {
                   table += "<tr>";
                    ...
                    table += "<td><button class='btn btn-outline-info' type='button' onclick='brdChkDelete(" + row[i].brdUid + ")'>삭제</button></td>";
                    table += "</tr>";
                }
            }
            $("#boardJS").html(table);
