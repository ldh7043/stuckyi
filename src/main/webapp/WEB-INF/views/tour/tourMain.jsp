...
<div id="buttons">
    <input class="form-label" type="text" id="tourname" style="margin:0px 0px 0px 275px;"
                 placeholder="예) 포스코미술관..">
    <button class="btn btn-outline-info" type="button" id="btn_search">관광지명
                 검색</button>
       <br><br>
    <button class="btn btn-outline-info" type="button" id="btn_load" style="margin:0px 0px 0px 275px;">관광지목록
                     가져오기</button>
    <button class="btn btn-outline-info" type="button" id="btn_remove" style="margin: 0 50px;">지우기</button>
...
<script>
   ...
   $(document).ready(function() {
    ...
    function parseXML(xmlDOM) {
       var cnt = 0;
       var table = "<tr id='thead'><th style='width:30%;'>관광지명</th><th style='width:60%;'>주소</th><th style='width:10%;'>전화번호</th></tr>";
