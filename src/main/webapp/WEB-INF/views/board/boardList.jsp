...
<body>
  ...
  <main id="main"></main>
  <section id="boardList" class="boardList">
	<h1 class="boardTitle">게시글 목록</h1>
      <div class="boardContainer">
  		
	    <table id="boardJSON"></table><br>
	    <div class="center">
			<ul class="pagination" id="pagination"></ul>
		</div>
		<button type="button" class='btn btn-outline-info' onclick="location.href='write'">작성</button><br>
	    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
	</div>
	</section>
	<div class="clear"></div>
...
<!-- ======= Footer ======= -->
  ...
  <script src="<%= request.getContextPath() %>/resources/assets/js/paging.js"></script>
