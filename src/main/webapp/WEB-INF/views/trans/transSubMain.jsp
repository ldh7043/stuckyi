      ...
      <section id="about" class="about">
         <div class="container">
            ...
            <div id="buttons" style="padding-bottom: 30px;">
               <input class="btn btn-outline-info" class="form-label" type="text" id="STATION"
                  style="margin: 0px 0px 0px 275px;" placeholder="예) 서울 역">
               ...
               <button class="btn btn-outline-info" type="button" id="btn_remove"
                  style="margin: 0 50px;">지우기</button><br>


               <!-- 테이블 생성 -->
               <br><br><div><table id="subXML"></table></div>
               
               <!-- 테이블 생성 -->
               
               <div id="loadbutton"><button type="button" id="load" class='btn btn-outline-info'>더보기</button></div>
            </div>
            <script>
var sublist = [];
var trID = [];
