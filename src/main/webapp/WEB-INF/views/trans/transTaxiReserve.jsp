...
<body>
  ...
  <section id="about" class="about">
      ...
      <td><sec:authorize access="isAuthenticated()">
         ...
         <h1 id="maintitle">콜 택 시  예 약 하 기</h1>
         <form id="frm" action="transReserveOk" method="post">

         <div id="taxireseve-container">
            <input type="hidden" name="userId" value="${user_id }">
            
            <div class="input-container">
            <br>출발장소 &nbsp;&nbsp;&nbsp;
               <img src="https://img.icons8.com/material/38/000000/home--v5.png"/>
               <input class="input-field" name="transAddr" type="text" value="${t.transAddr }" required>
            </div>
            
            <div class="input-container">
            <br>예약날짜 &nbsp;&nbsp;&nbsp;
               <img src="https://img.icons8.com/material-rounded/38/000000/time-machine.png" />
               <input class="input-field" name="transDate" type="date" value="${t.transDate }" style="width: 420px;" required>
            </div>
            
            <div class="input-container">
            <br>예약시간 &nbsp;&nbsp;&nbsp;
               <img src="https://img.icons8.com/material-rounded/38/000000/time-machine.png" />
               <input class="input-field" name="transTime" type="text" style="width: 420px" value="${t.transTime }" required>
            </div>
            
            <div class="input-container">
            <br>탑승자명 &nbsp;&nbsp;&nbsp;
               <img src="https://img.icons8.com/wired/38/000000/employee-card.png" />
               <input class="input-field" name="transName" type="text" value="${t.transName }" required>
            </div>
            
            <div class="input-container">
            <br>요청사항 &nbsp;&nbsp;&nbsp;
               <img src="https://img.icons8.com/material/38/000000/speech-bubble--v4.png" />
               <input class="input-field" name="transComment" style="height:200px" type="text" value="${t.transComment }">
            </div>
