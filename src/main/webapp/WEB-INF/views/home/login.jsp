...
<section id="loginPage" class="loginPage">
    ...
    아이디: <input class='btn btn-outline-info' type='text' name='username' value='admin'><br><br>
    비밀번호: <input class='btn btn-outline-info' type="password" name='password' value='admin' style="font-family:sans-serif"><br><br>
    <input type='submit' class='btn btn-outline-info' value='로그인'><br><br>
    <a class='btn btn-outline-info' href='http://localhost:8033/stuckyi/join/join'>회원가입</a><br>
