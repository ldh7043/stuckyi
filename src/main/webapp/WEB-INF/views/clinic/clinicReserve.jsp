...
<body>
   ...
   <section id="about" class="about">
      ...
      <td><sec:authorize access="isAuthenticated()">
         ...
         <h1 id="maintitle">병 원 예 약 하 기</h1>
         <form id="frm" action="clinicReserveOk" method="post">
            
            <input type="hidden" name="userId" value="${user_id }">
            
            <div class="input-container">
            <br>병원이름 &nbsp;&nbsp;&nbsp;
               <img src="https://img.icons8.com/metro/38/000000/hospital-3.png"/>
               <input class="input-field" name="hosTitle" type="text" value="${h.hosTitle }" required>
            </div>
            
            <div class="input-container">
            <br>예약날짜 &nbsp;&nbsp;&nbsp;
               <img src="https://img.icons8.com/material-rounded/38/000000/time-machine.png" />
               <input class="input-field" name="resDate" type="date" value="${h.resDate }" style="width: 420px;" required>
            </div>
            
            <div class="input-container">
            <br>예약시간 &nbsp;&nbsp;&nbsp;
               <img src="https://img.icons8.com/material-rounded/38/000000/time-machine.png" />
               <input class="input-field" name="hosTime" type="text" value="${h.hosTime }" required>
            </div>
            
            <div class="input-container">
            <br>진료과목 &nbsp;&nbsp;&nbsp;
               <img src="https://img.icons8.com/ios/38/000000/body-type-tall.png" />
               <input class="input-field" name="hosType" type="text" value="${h.hosType }" required>
            </div>
            
            <div class="input-container">
            <br>환자성명 &nbsp;&nbsp;&nbsp;
               <img src="https://img.icons8.com/wired/38/000000/employee-card.png" />
               <input class="input-field" name="hosName" type="text" value="${h.hosName }" required>
            </div>
            
            <div class="input-container">
            <br>전화번호 &nbsp;&nbsp;&nbsp;
               <img src="https://img.icons8.com/metro/38/000000/phone-disconnected.png" />
               <input class="input-field" name="hosPh" type="text" value="${h.hosPh }">
            </div>
            <div id="submitbutton"><button style="width: 400px;" class="btn btn-outline-success btn-lg" type="submit">예약등록</button></div>
            <input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }" />
         </form>
