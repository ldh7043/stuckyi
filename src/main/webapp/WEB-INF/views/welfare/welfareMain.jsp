      ...
      <div class="container">
        <div class="row no-gutters">
			 ...
			 <div class="section-title">
			    ...
			    <button type="button" id="loadWelfare" class='btn btn-outline-info'>더보기</button>
			    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
			    ...
			    <script>
			        ...
			        function parseJSON(jsonObj){
			            ...
			            var table="<tr id='welfareTitle'><th>시설명</th><th>시설코드</th><th>시설종류명</th><th>시설주소</th></tr>";
			            for (i = 0; i < row.length; i++) { 
			                table += "<tr style='display: none;' id='welfare"+ cnt + "'>";
							
			                table += "<td><a href='http://localhost:8033/stuckyi/main/welfareInfo'>" + row[i].FCLT_NM + "</a></td>";
			                table += "<td>" + row[i].FCLT_CD + "</td>";
			                table += "<td>" + row[i].FCLT_KIND_NM + "</td>";
			                table += "<td>" + row[i].FCLT_ADDR + "</td>";
			                table += "</tr>";
			                WID.push(cnt);
			                cnt++;
			            } // end for
